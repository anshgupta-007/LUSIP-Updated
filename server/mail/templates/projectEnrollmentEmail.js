const projectEnrollmentEmail = (projectName, name) => {
    ...
    <body>
        <div class="container">
            ...
            <!-- Support Info -->
            <div class="support">
                If you have any questions or need assistance, feel free to contact us at <a href="sandeep.saini@lnmiit.ac.in">sandeep.saini@lnmiit.ac.in</a>. We're here to help!
            </div>
        </div>
